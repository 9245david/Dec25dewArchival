...
#define BLOCK_SIZE (MB_SIZE*16UL)
...
typedef struct taskBlock{
	int32_t chunkID;
	//条带号从0开始
	int32_t localTaskBlock[EREASURE_N];
		//本地需要读取的数据块，长度信息以数组中的结束标志int值自带
		//数组未满部分以-1填充
	uint32_t waitForBlock;
